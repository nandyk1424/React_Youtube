    ...
    return (
        <div className="header">
            ...
            <div className="header_icons" >
                ...
                <Avatar alt="Nandhini" src="https://i.pinimg.com/736x/ef/b4/56/efb4563befb0ae1bed74f004785f3f0f.jpg" />
            </div>
        </div>
    );
}
